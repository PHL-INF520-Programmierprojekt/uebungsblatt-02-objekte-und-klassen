...
You will find the sources in the [`de.phl.programmingproject.petadoption`](src/main/java/de/phl/programmingproject/petadoption/) package.

#### Pet Class

The [`Pet`](src/main/java/de/phl/programmingproject/petadoption/Pet.java) class represents a pet in the adoption center. It has the following operations:
...
The [`Adopter`](src/main/java/de/phl/programmingproject/petadoption/Adopter.java)  class represents a person who adopts a pet. It has the following operations:
...
The [`Adoption`](src/main/java/de/phl/programmingproject/petadoption/Adoption.java)  class represents a pet adoption. It has the following operations:
...
Implement the following tasks in the `main` method located in the [`Main`](src/main/java/de/phl/programmingproject/petadoption/Main.java) class in the `de.phl.programmingproject.petadoption` package.
...
You will find the sources in the [`de.phl.programmingproject.enrollmentsystem`](src/main/java/de/phl/programmingproject/enrollmentsystem/) package.

### Classes

1. [`Student`](src/main/java/de/phl/programmingproject/enrollmentsystem/Student.java): This class has the following attributes: name (`String`), id (`String`), and a set of enrolled enrollments (`Set<Enrollment>`). It should also have the following operations:
...
2. [`Course`](src/main/java/de/phl/programmingproject/enrollmentsystem/Course.java): This class should have the following attributes: name (`String`), and a list of enrolled students (`List<Student>`). It should also have the following operations:
...
3. [`Enrollment`](src/main/java/de/phl/programmingproject/enrollmentsystem/Enrollment.java): This class should have the following attributes: student (`Student`), course (`Course`), and grade (`double`). It should also have the following operations:
